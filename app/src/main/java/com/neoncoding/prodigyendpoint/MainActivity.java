...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText)findViewById(R.id.ipInput)).setText(sharedPref.getString("ip", "YOURSERVERIPANDPORTHERE"));
        ((EditText)findViewById(R.id.bssidInput)).setText(sharedPref.getString("bssid", "YOURBSSIDHERE"));
    ...
    public void onTestNotification(View view) {
        ...
        if (!bssid.contains(sharedPref.getString("bssid", "YOURBSSIDHERE"))) return;
        ...
        JsonObjectRequest jor = new JsonObjectRequest(Request.Method.POST, "http://" + sharedPref.getString("ip", "YOURSERVERIPANDPORTHERE"), content, new Response.Listener<JSONObject>() {
            @Override
